        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.sm }}>
          ...
          {tab === 'boards' && (
            <InfoTooltip
              ...
              text={t("Tes tableaux fonctionnent comme des moodboards : épingle tes citations par thème (Résilience, Amour, Nuit…). Un tableau peut rester privé, devenir public sur ton profil, ou collaboratif pour épingler à plusieurs.")}
            />
          )}
        </View>
